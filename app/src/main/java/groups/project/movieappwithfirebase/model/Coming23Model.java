...
public class Coming23Model {
    ...
    public Coming23Model() {
    }

    public Coming23Model(String ccover, String cdes, String clink, String cthumb, String ctitle, String ccast, String tlink) {
        Ccover = ccover;
        Cdes = cdes;
        Clink = clink;
        Cthumb = cthumb;
